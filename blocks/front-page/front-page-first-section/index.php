...
<?php endif; ?>
	...
	<div class="max-w-huge mx-auto relative z-30">
		...
		<div class="max-w-[568px] relative z-20 md:pb-0 pb-[390px]">
			...
			<a href="#"
			   data-modal="form"
			   class="bg-red hover:bg-red-500 transition-all duration-300 rounded-60 md:px-16 px-5 pt-4 pb-5 text-white font-extrabold text-pure-text-pc flex items-center justify-center gap-6 md:w-fit w-full md:max-w-none max-w-[320px] whitespace-nowrap">
