					...
					while ( have_rows( 'slajder_kartinok' ) ) :
						...
						<?php if ( $djun_kartinka ) : ?>
							<img src="<?php echo esc_url( $djun_kartinka['url'] ); ?>"
								 class="block z-30 fade-in-slide object-cover object-center xl:w-[779px] h-auto lg:w-[585px] w-full three-d-tour-slide <?php echo esc_attr( 0 === $djun_img_count ? 'relative' : 'absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2' ); ?>"
