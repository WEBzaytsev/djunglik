 ...
 */
function djun_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'djun_customize_register' );
 ...
 * @return void
 */
function djun_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function djun_customize_partial_blogdescription() {
